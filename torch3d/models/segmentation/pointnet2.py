...
class PointNetSSG(nn.Module):
    def __init__(self, in_channels, num_classes, dropout=0.5):
        ...
        self.conv1 = SetConv(in_channels, [32, 32, 64], 1024, 32, 0.1, bias=False)
        self.conv2 = SetConv(64 + 3, [64, 64, 128], 256, 32, 0.2, bias=False)
        self.conv3 = SetConv(128 + 3, [128, 128, 256], 64, 32, 0.4, bias=False)
        self.conv4 = SetConv(256 + 3, [256, 256, 512], 16, 32, 0.8, bias=False)
